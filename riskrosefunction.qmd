...
```{r}
#| label: testing-oldsheet
#| warning: False
#| message: False
#| echo: False

rose = riskroseFromCSV("~/desktop/new risk rose.csv")
rose
```

```{r}
#| label: testing-alllevel2rose
#| warning: False
#| message: False
#| echo: False

risks = load_data("~/desktop/all2.csv") 
data1 = getLevel1Table(risks)
data2 = getLevel2Table(risks)
data3 = getLevel3Table(risks)
data4 = risks |> 
...
plotlyrisks = rbind(data1, data2, data3, data4)
plotlyrisksformatted = createLabels(plotlyrisks)
riskrose2 = createRose(plotlyrisksformatted)

htmlwidgets::saveWidget(riskrose2, "alllevel2.html")
