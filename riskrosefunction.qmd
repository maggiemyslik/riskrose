...
load_data = function(filepath) {
  ...
  risks = read_csv(filepath, skip = 2)
...
getColorOuter = function(estrisk, global_min, global_max) {
  ...
  # convert numeric values into a scale from 0 to 1 to standardize risk level ratings 
    ...
    color_matrix = colorRamp(c("#6aa84f", "#ffbf00", "#d61f1f"))(normalized_estrisk)
...
riskroseFromCSV("~/desktop/Climate Risk Rose for Airports.csv")
```
